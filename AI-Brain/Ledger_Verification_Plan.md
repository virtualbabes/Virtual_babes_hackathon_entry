Based on the current architecture and the verification note in Problems.md (Task 1.1), here is a detailed implementation and verification plan.
...
Logic: This function currently broadcasts the FaucetBalance (Physical) and individual VirtualBalance records. To support ledger verification, we should calculate the Total Virtual Liability (the sum of all l.playerBalances).
