...
*   **296**: Audited `startSalaryDispenser` in `career.go`; hardened persistence by triggering immediate leaderboard and economy saves following daily payouts and optimized performance by moving dynamic scaling out of the payment loop.
