...
export function animateParticles() {
    ...
    // Cap active particles at 500 to prevent frame drops on lower-end devices 
    // during massive combo chain reactions or victory Fanfare.
...
/**
 * Spawns an unstable "Kidnap" burst when a card is taken hostage.
 * Features high-jitter digital lines and orange energy pulses.
 */
export function triggerKidnapParticles(gridIndex) {
    if (!particleCtx) return;
    ...
    for (let i = 0; i < 60; i++) {
        ...
        particles.push({
            ...
            color: { r: 255, g: 100, b: 0 }, // Hostage Orange
...
/**
 * Spawns a global, glitchy orange particle effect for kidnapping events.
 */
export function triggerGlobalKidnapEffect() {
    ...
    for (let i = 0; i < 100; i++) {
        ...
        particles.push({
            ...
            color: { r: 255, g: 140, b: 0 }, // Darker orange
            life: Math.random() * 60 + 30,
            initialLife: 90,
            type: "data-line",
            isGlitchy: true,
            wantedLevel: 0 // Not player specific, so no wanted level
        });
    }
...
window.triggerKidnapParticles = triggerKidnapParticles;
